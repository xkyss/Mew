...
- 实施补充（2026-09-26）:上游 [MewUI#253](https://github.com/aprillz/MewUI/issues/253)（tooltip 显示时首次点击不触发 Click,0.21.1 未修）波及高频点击路径,已摘除活动栏/主题按钮 ToolTip 绕过;**下次升级 MewUI 时恢复**,详见票据 03 与 ADR-000304-01。
